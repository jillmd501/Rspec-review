...
describe "Library object" do
  ...
  describe "#new" do
    ...
    context "with a yaml file paramter" do
      it "has 5 books" do
  ...
  it "accepts new books" do
    @lib.add_book(Book.new("Desigining for the Web", "Mark Boulton", :design))
    @lib.get_book("Desigining for the Web").should  be_an_instance_of Book
  end
